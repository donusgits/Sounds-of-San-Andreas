...
import com.github.donus.sosa.sounds.*;
...
@Slf4j
@PluginDescriptor(
	name = "Sounds of San Andreas",
	description = "Bring GTA:SA to Gielenor",
	tags = {"GTA", "san", "andreas", "stats", "levels", "quests", "diary", "announce"}
)

public class SOSAPlugin extends Plugin
{
	@Inject
	...
	@Provides
	SOSAConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(SOSAConfig.class);
	}

	@Subscribe
	public void onConfigChanged(ConfigChanged event)
	{
		if (SOSAConfig.CONFIG_GROUP.equals(event.getGroup()))
		{
